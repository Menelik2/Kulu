...
import { adminGetOrder, adminUpdateOrderStatus, adminDeleteOrder } from '@/services/admin'
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            onClick={() => {
              if (
                confirm(
                  `Delete order ${order.order_number}? This cannot be undone. Order items will be removed too.`
                )
              ) {
                del.mutate()
              }
      ...
      <div className="bg-white rounded-xl border overflow-hidden">
        ...
        <div className="border-t p-4 space-y-1 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span>{formatETB(order.delivery_fee)}</span>
          </div>
