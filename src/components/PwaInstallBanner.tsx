...
export function PwaInstallBanner() {
  const { showBanner, isIosHint, installing, promptInstall, dismiss } = usePwaInstall()
  const { t } = useLanguage()
  ...
  return (
    <div
      className="fixed left-3 right-3 z-[60] md:left-auto md:right-4 md:w-[360px] bottom-[4.75rem] md:bottom-6 safe-bottom"
      role="dialog"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-charcoal-500 mt-0.5 leading-snug">
              {isIosHint ? t('installIosHint') : t('installAppDesc')}
            </p>
          </div>
          <button
            type="button"
